...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	private void initDB() throws IOException {
		//1. 初始化归属地数据库
		initPhonelocation("address.db");
	}

	private void initPhonelocation(String dbName) throws IOException {
		//1. 获取文件的路径
		...
		ToastUtil.show(getApplicationContext(),"文件写入完毕");
